        ...
        >
          <ul className="navbar-nav text-center  justify-content-between">
            <li className="nav-item active d-flex  align-items-center">
              <a href="/" className="pb-1 px-1 text-hover">
                <svg
            ...
            <li className="nav-item  d-flex align-items-center">
              ...
              <a className="nav-link hover text-hover" href="#about">
                About
              </a>
            </li>
            <li className="nav-item  d-flex align-items-center">
              ...
              <a className="nav-link hover text-hover" href="#resume">
                Resume
              </a>
            </li>
            <li className="nav-item  d-flex align-items-center">
              ...
              <a className="nav-link hover text-hover" href="#project">
                Projects
              </a>
            </li>
            <li className="nav-item  d-flex align-items-center">
              ...
              <a className="nav-link hover text-hover" href="#contact">
                Contact
              </a>
            </li>
          </ul>
